...
export class Scene {
	 ...
	 */
	SetSkybox(skybox) {
		binding.Scene$SetSkybox(
			this.internal,
			skybox ? skybox.internal : undefined,
		);
	}
	...
	GetSkybox() {
		...
		if (skyboxInternal == undefined) return undefined;
	...
	SetIndirectLight(ibl) {
		binding.Scene$SetIndirectLight(
			this.internal,
			ibl ? ibl.internal : undefined,
		);
	}
	...
	GetIndirectLight() {
		...
		if (iblInternal == undefined) return undefined;
