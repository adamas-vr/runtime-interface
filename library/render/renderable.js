...
export class RenderableManager
{
    ...
    static SetAxisAlignedBoundingBox(entity, aabb) {
        binding.RenderableManager$SetAxisAlignedBoundingBox(entity, aabb.center, aabb.halfExtent);
    }
    ...
    */
    ...
    static GetAxisAlignedBoundingBox(entity) {
        let ret = binding.RenderableManager$GetAxisAlignedBoundingBox(entity, vec3.fromValues);
    ...
    static SetMaterialInstanceAt(entity, primitiveIndex, materialInstance) {
        binding.RenderableManager$SetMaterialInstanceAt(entity, primitiveIndex, materialInstance.internal);
    }
    static GetMaterialInstanceAt(entity, primitiveIndex) {
        return new MaterialInstance(binding.RenderableManager$GetMaterialInstanceAt(entity, primitiveIndex));
    }
    static SetGeometryAt(entity, primitiveIndex, type, vertices, indices, offset, count) {
...
export class RenderableBuilder
{
     ...
     */
    Geometry(index, type, vertices, indices, offset = undefined, count = undefined) {
        binding.RenderableBuilder$Geometry(this.internal, index, type, 
            vertices.internal, indices.internal, offset, count
        );
        return this;
    }
    ...
    Material(index, materialInstance) {
        binding.RenderableBuilder$Material(this.internal, index, materialInstance.internal);
        return this;
    }
    ...
    BoundingBox(axisAlignedBoundingBox) {
        binding.RenderableBuilder$BoundingBox(this.internal, 
            axisAlignedBoundingBox.center, axisAlignedBoundingBox.halfExtent
        );
        return this;
    }
    ...
    GlobalBlendOrderEnabled(primitiveIndex, enabled) {
        binding.RenderableBuilder$GlobalBlendOrderEnabled(this.internal, primitiveIndex, enabled);
        return this;
    }
