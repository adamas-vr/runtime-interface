...
export const TextureFormat = Object.freeze({
    // 8-bits per element
    R8: 0, R8_SNORM: 1, R8UI: 2, R8I: 3, STENCIL8: 4,

    // 16-bits per element
    R16F: 5, R16UI: 6, R16I: 7,
    RG8: 8, RG8_SNORM: 9, RG8UI: 10, RG8I: 11,
    RGB565: 12,
    ...
    // 24-bits per element
    RGB8: 17, SRGB8: 18, RGB8_SNORM: 19, RGB8UI: 20, RGB8I: 21,
    DEPTH24: 22,

    // 32-bits per element
    R32F: 23, R32UI: 24, R32I: 25,
    RG16F: 26, RG16UI: 27, RG16I: 28,
    R11F_G11F_B10F: 29,
    RGBA8: 30, SRGB8_A8: 31, RGBA8_SNORM: 32,
    UNUSED: 33, // used to be rgbm
    RGB10_A2: 34, RGBA8UI: 35, RGBA8I: 36,
    DEPTH32F: 37, DEPTH24_STENCIL8: 38, DEPTH32F_STENCIL8: 39,

    // 48-bits per element
    RGB16F: 40, RGB16UI: 41, RGB16I: 42,

    // 64-bits per element
    RG32F: 43, RG32UI: 44, RG32I: 45,
    RGBA16F: 46, RGBA16UI: 47, RGBA16I: 48,

    // 96-bits per element
    RGB32F: 49, RGB32UI: 50, RGB32I: 51,

    // 128-bits per element
    RGBA32F: 52, RGBA32UI: 53, RGBA32I: 54,

    // compressed formats

    // Mandatory in GLES 3.0 and GL 4.3
    EAC_R11: 55, EAC_R11_SIGNED: 56, EAC_RG11: 57, EAC_RG11_SIGNED: 58,
    ETC2_RGB8: 59, ETC2_SRGB8: 60,
    ETC2_RGB8_A1: 61, ETC2_SRGB8_A1: 62,
    ETC2_EAC_RGBA8: 63, ETC2_EAC_SRGBA8: 64,

    // Available everywhere except Android/iOS
    DXT1_RGB: 65, DXT1_RGBA: 66, DXT3_RGBA: 67, DXT5_RGBA: 68,
    DXT1_SRGB: 69, DXT1_SRGBA: 70, DXT3_SRGBA: 71, DXT5_SRGBA: 72,
...
export class Texture
{
    ...
    static ComputeTextureDataSize(format, type, stride, height, alignment) {
        return binding.Texture$ComputeTextureDataSize(format, type, stride, height, alignment);
    }
    ...
    SetImage(level, xoffset, yoffset, zoffset, width, height, depth, buffer) {
        binding.Texture$SetImage(this.internal,
            level, xoffset, yoffset, zoffset,
            width, height, depth,
            buffer.buffer, buffer.pixelDataFormat, buffer.pixelDataType
        );
    }
...
export class TextureBuilder
{
     ...
     */
    Build() {
        return new Texture(binding.TextureBuilder$Build(
            this.width, this.height, this.depth, this.levels,
            this.target, this.format, this.usage, this.rgba
        ));
    }
