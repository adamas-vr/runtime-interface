...
export class IndirectLightBuilder
{
    ...
    Build() {
        if (!this.mReflections)
            throw "Reflection cubemap must be provided";
        return new IndirectLight(binding.IndirectLightBuilder$Build(
            this.mReflections.internal, this.mIntensity, this.mRotation
        ));
    }
