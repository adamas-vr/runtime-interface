...
export class RenderTarget
{
    ...
    GetTexture(attachment) {
        return new Texture(binding.RenderTarget$GetTexture(this.internal, attachment));
    }
    ...
    GetSupportedColorAttachmentsCount() {
        return binding.RenderTarget$GetSupportedColorAttachmentsCount(this.internal);
    }
};
...
export class RenderTargetBuilder
{
    ...
    Texture(attachment, texture) {
        binding.RenderTargetBuilder$Texture(this.internal, attachment, texture.internal);
        return this;
    }
